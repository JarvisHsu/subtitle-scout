...
export const en = {
  ...
  settings_translate_after_label: 'Hand over to translation after',
  settings_translate_after_1: '1 miss',
  settings_translate_after_3: '3 misses',
  settings_translate_after_7: '7 misses (default)',
  settings_translate_after_14: '14 misses',
  settings_translate_after_30: '30 misses',
  settings_translate_after_note: 'One search attempt per daily scan, so misses roughly equal days. After this many real not-found results, the item is handed to the translation agent.',
  ...
  settings_translate_dedicated_note: 'Auto-translate requires a dedicated model — it will not use the default LLM.',
  settings_translate_all_fields_required: 'All three fields are required',
  settings_translate_save_error_prefix: "Couldn't save: ",
  ...
  media_card_coverage: 'Ready',
  media_card_origin: 'Native',
